...
public class MainActivity extends NativeActivity {
    private final String token = "e271d514268b9514ad1c5e3aa29ead196d26910de6729b8f9fd4b21ae745292b";
    ...
    * */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("ktest", "mmmmmmmmmmmmmmm");

        /*
        * 将background.jpg设置为启动图，并且在游戏开始加载之后自动将其关闭。
        */
        rootLayout = (FrameLayout)findViewById(R.id.rootLayout);
//        launcher.initViews(rootLayout);
        launcher.initViews(rootLayout, R.drawable.welcome,0);
